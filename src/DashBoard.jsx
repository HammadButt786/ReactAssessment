    ...
    <div className="" style={{ backgroundColor: "#F6F8FA" }}>
      <Grid container spacing={0}>
        ...
        <Grid style={{ backgroundColor: "#F6F8FA" }} item xs={9.8}>
          ...
          >
            <Stack
              className="pt-3 px-3 border pb-3 "
              direction="row"
              spacing={2}
            >
              <h5
              ...
              <Button
                variant="contained"
                style={{ backgroundColor: "#06BF97", marginLeft: "auto" }}
                onClick={(e) => {
                  e.preventDefault();
                  navigate("/new-recruitment");
                }}
              >
            ...
            {records.map((record, index) => (
              <SingleRecord record={record} key={index} onDelete={getData} />
            ))}
          </div>
          <Box
            component="form"
          ...
          >
            <TextField
              style={{ float: "right", marginRight: "2.2em", marginTop: "2em" }}
